...
class Plot(go.Figure):
    ...
    def add_bar(
        ...
        hovertemplate: str | float | Sequence[str] | Sequence[float] | np.ndarray[tuple[int, ...], np.dtype[np.float64]] = ...,
        hovertemplatesrc: str = ...,
        hovertext: str | float | Sequence[str] | Sequence[float] | np.ndarray[tuple[int, ...], np.dtype[np.float64]] = ...,
        hovertextsrc: str = ...,
        ...
        metasrc: str = ...,
        name: str | int = ...,
        offset: float | Sequence[int] | Sequence[float] | np.ndarray[tuple[int, ...], np.dtype[np.float64]] = ...,
        offsetgroup: str | int = ...,
        offsetsrc: str = ...,
        opacity: float = ...,
        orientation: str = ...,
        ...
        textpositionsrc: str = ...,
        textsrc: str = ...,
        texttemplate: str | float | Sequence[str] | Sequence[float] | np.ndarray[tuple[int, ...], np.dtype[np.float64]] = ...,
        texttemplatesrc: str = ...,
        uid: str | int = ...,
        uirevision: Hashable = ...,
        unselected: bar.Unselected | dict[str, bar.unselected.Marker | bar.unselected.Textfont | dict[str, Any]] = ...,
        visible: bool | str = ...,
        width: float | Sequence[int] | Sequence[float] | np.ndarray[tuple[int, ...], np.dtype[np.float64]] = ...,
        widthsrc: str = ...,
    ...
    def add_barpolar(
        ...
        rsrc: str = ...,
        selected: barpolar.Selected | dict[str, barpolar.selected.Marker | barpolar.selected.Textfont | dict[str, Any]] = ...,
        selectedpoints: Sequence[int] = ...,
        showlegend: bool = ...,
        ...
        uid: str | int = ...,
        uirevision: Hashable = ...,
        unselected: barpolar.Unselected | dict[str, barpolar.unselected.Marker | barpolar.unselected.Textfont | dict[str, Any]] = ...,
        visible: bool | str = ...,
    ...
    def add_box(
        ...
        lowerfence: Sequence[int] | Sequence[float] | np.ndarray[tuple[int, ...], np.dtype[np.float64]] | pd.Series[float] = ...,
        lowerfencesrc: str = ...,
        ...
        upperfence: Sequence[int] | Sequence[float] | np.ndarray[tuple[int, ...], np.dtype[np.float64]] | pd.Series[float] = ...,
        upperfencesrc: str = ...,
        visible: bool | str = ...,
        whiskerwidth: float = ...,
        width: float = ...,
    ...
    def add_histogram(
        ...
        orientation: str = ...,
        outsidetextfont=...,  # pyright: ignore[reportMissingParameterType]
        selected: histogram.Selected | dict[str, histogram.selected.Marker | histogram.selected.Textfont | dict[str, Any]] = ...,
        selectedpoints: Sequence[int] = ...,
        showlegend: bool = ...,
        ...
        uid: str | int = ...,
        uirevision: Hashable = ...,
        unselected: histogram.Unselected | dict[str, histogram.unselected.Marker | histogram.unselected.Textfont | dict[str, Any]] = ...,
        visible: bool | str = ...,
        x=...,  # pyright: ignore[reportMissingParameterType]
        xaxis: str = ...,
    ...
    def add_scatter(
        ...
        opacity: float = ...,
        orientation: str = ...,
        selected: scatter.Selected | dict[str, scatter.selected.Marker | scatter.selected.Textfont | dict[str, Any]] = ...,
        selectedpoints: Sequence[int] = ...,
        showlegend: bool = ...,
        stackgaps: str = ...,
        stackgroup: str | int = ...,
        ...
        uid: str | int = ...,
        uirevision: Hashable = ...,
        unselected: scatter.Unselected | dict[str, scatter.unselected.Marker | scatter.unselected.Textfont | dict[str, Any]] = ...,
        visible: bool | str = ...,
    ...
    def add_scattergeo(
        ...
        name: str | int = ...,
        opacity: float = ...,
        selected: scattergeo.Selected | dict[str, scattergeo.selected.Marker | scattergeo.selected.Textfont | dict[str, Any]] = ...,
        selectedpoints: Sequence[int] = ...,
        showlegend: bool = ...,
        ...
        uid: str | int = ...,
        uirevision: Hashable = ...,
        unselected: scattergeo.Unselected | dict[str, scattergeo.unselected.Marker | scattergeo.unselected.Textfont | dict[str, Any]] = ...,
        visible: bool | str = ...,
        row=...,  # pyright: ignore[reportMissingParameterType]
        col=...,  # pyright: ignore[reportMissingParameterType]
        **kwargs: Any,
    ...
    def add_scattergl(
        ...
        name: str | int = ...,
        opacity: float = ...,
        selected: scattergl.Selected | dict[str, scattergl.selected.Marker | scattergl.selected.Textfont | dict[str, Any]] = ...,
        selectedpoints: Sequence[int] = ...,
        showlegend: bool = ...,
        ...
        uid: str | int = ...,
        uirevision: Hashable = ...,
        unselected: scattergl.Unselected | dict[str, scattergl.unselected.Marker | scattergl.unselected.Textfont | dict[str, Any]] = ...,
        visible: bool | str = ...,
        x=...,  # pyright: ignore[reportMissingParameterType]
        x0: float = ...,
        xaxis: str = ...,
    ...
    def add_scatterpolar(
        ...
        r0=...,  # pyright: ignore[reportMissingParameterType]
        rsrc: str = ...,
        selected: scatterpolar.Selected | dict[str, scatterpolar.selected.Marker | scatterpolar.selected.Textfont | dict[str, Any]] = ...,
        selectedpoints: Sequence[int] = ...,
        showlegend: bool = ...,
    ...
    def add_scattersmith(
        ...
        realsrc: str = ...,
        selected: scattersmith.Selected | dict[str, scattersmith.selected.Marker | scattersmith.selected.Textfont | dict[str, Any]] = ...,
        selectedpoints: Sequence[int] = ...,
        showlegend: bool = ...,
