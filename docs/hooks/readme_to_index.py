...
docs.hooks.generate_dependency_groups : Sibling ``on_pre_build`` hook that refreshes the extras table.
...
def on_pre_build(
    ...
    **_kwargs
    ...
    docs.hooks.generate_dependency_groups : Sibling hook that refreshes the dependency-groups guide.
