...
def impl_new_list(item, allocated=...):  # -> Callable[..., Any]:
    ...
    ...
@overload(len)
def impl_len(l):  # -> Callable[..., Callable[..., Any]] | None:

    ...
@overload_method(types.ListType, "_allocated")
def impl_allocated(l):  # -> Callable[..., Callable[..., Any]] | None:
...
def impl_getitem(l, index):  # -> Callable[..., Callable[..., Any]] | Callable[..., None] | Callable[..., list[Any]] | None:
    ...
...
def ol_getitem_unchecked(lst, index):  # -> Callable[..., Callable[..., Any]] | None:
    ...
...
def impl_dtype(l):  # -> Callable[..., Any | None] | None:
    ...
