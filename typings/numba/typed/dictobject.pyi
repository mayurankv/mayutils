...
def impl_new_dict(key, value, n_keys=...):  # -> Callable[..., Any]:
    ...
    ...
@overload(len)
def impl_len(d):  # -> Callable[..., Callable[..., Any]] | None:

    ...
@overload(len)
def impl_len_iters(d):  # -> Callable[..., Callable[..., Any]] | None:
...
def impl_getitem(d, key):  # -> Callable[..., Callable[..., Any]] | None:
    ...
@overload_method(types.DictType, "popitem")
def impl_popitem(d):  # -> Callable[..., Callable[..., Any]] | None:
    ...
...
def impl_items(d):  # -> Callable[..., Callable[..., Any]] | None:
    ...
@overload_method(types.DictType, "keys")
def impl_keys(d):  # -> Callable[..., Callable[..., Any]] | None:
    ...
@overload_method(types.DictType, "values")
def impl_values(d):  # -> Callable[..., Callable[..., Any]] | None:
    ...
@overload_method(types.DictType, "update")
def ol_dict_update(d, other):  # -> Callable[..., None] | None:
    ...
@overload(operator.eq)
def impl_equal(da, db):  # -> Callable[..., Literal[False]] | Callable[..., bool] | None:
    ...
...
def literalstrkeydict_impl_values(d):  # -> Callable[..., Callable[..., Any]] | None:
    ...
...
def literalstrkeydict_impl_items(d):  # -> Callable[..., Callable[..., Any]] | None:
    ...
@overload(operator.contains)
