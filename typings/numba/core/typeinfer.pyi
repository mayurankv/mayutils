...
class TypeVar:
    ...
    def getone(self):  # -> Type:
        ...
    def __len__(self) -> int:  # -> Literal[1, 0]:
        ...
...
class TypeInferer:
    ...
    def unify(
        self, raise_errors=...
    ):  # -> tuple[UniqueDict, Generator | FunctionType | Any | numba.core.types.misc.NoneType | None, UniqueDict | None]:
    ...
    def sentry_modified_builtin(self, inst, gvar):  # -> None:
        ...
        ...
    def resolve_call(self, fnty, pos_args, kw_args):  # -> Any | Signature | None:
