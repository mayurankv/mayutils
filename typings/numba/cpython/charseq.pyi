...
def is_default(x, default):  # -> bool:
    ...
@register_jitable
def unicode_charseq_get_value(a, i):  # -> ndarray[_AnyShape, dtype[Any]]:
...
def charseq_getitem(s, i):  # -> Callable[..., ndarray[_AnyShape, dtype[Any]] | Any] | None:
    ...
@overload(len)
def charseq_len(s):  # -> Callable[..., Literal[0]] | Callable[..., Any] | None:
    ...
@overload(operator.add)
@overload(operator.iadd)
def charseq_concat(a, b):  # -> Callable[..., Any] | Callable[..., str] | None:
    ...
...
def unicode_to_bytes_mth(s):  # -> Callable[..., Callable[..., Any]]:
...
def unicode_charseq_find(a, b):  # -> Callable[..., int] | Callable[..., Any] | None:
    ...
@overload_method(types.UnicodeCharSeq, "rfind")
@overload_method(types.CharSeq, "rfind")
@overload_method(types.Bytes, "rfind")
def unicode_charseq_rfind(a, b):  # -> Callable[..., int] | Callable[..., Any] | None:
    ...
