...
def seed_impl(seed):  # -> Callable[..., Callable[..., Any]] | None:
    ...
...
@overload(np.random.sample)
@overload(np.random.ranf)
def random_impl1(size=...):  # -> Callable[..., float] | Callable[..., NDArray[Any]] | Callable[..., Any] | None:
    ...
...
def np_gauss_impl2(loc, scale):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.standard_normal)
def standard_normal_impl1(size):  # -> Callable[..., float] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
@overload(np.random.normal)
def np_gauss_impl3(loc, scale, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
@overload(random.getrandbits)
def getrandbits_impl(k):  # -> Callable[..., Callable[..., Any]] | None:
    ...
...
def np_randint_impl_2(low, high):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.randint)
def np_randint_impl_3(low, high, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
...
def uniform_impl(state, a_preprocessor, b_preprocessor):  # -> Callable[..., Any]:
    ...
@overload(np.random.uniform)
def np_uniform_impl3(low, high, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
...
def triangular_impl_3(left, mode, right):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.triangular)
def triangular_impl(left, mode, right, size=...):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | None:
    ...
...
def ol_np_random_gamma2(shape, scale):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.gamma)
def gamma_impl(shape, scale, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
@overload(np.random.standard_gamma)
def standard_gamma_impl(shape, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
@overload(random.betavariate)
def betavariate_impl(alpha, beta):  # -> Callable[..., float] | None:
    ...
@overload(np.random.beta)
def ol_np_random_beta(a, b):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.beta)
def beta_impl(a, b, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
...
def exponential_impl(scale):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.exponential)
def exponential_impl(scale, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
...
def exponential_impl():  # -> Callable[[], float]:
    ...
@overload(np.random.standard_exponential)
def standard_exponential_impl(size):  # -> Callable[..., float] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
...
def np_log_normal_impl2(mean, sigma):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.lognormal)
def lognormal_impl(mean, sigma, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
...
def pareto_impl(a):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.pareto)
def pareto_impl(a, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
...
def weibull_impl(a):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.weibull)
def weibull_impl2(a, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
@overload(random.vonmisesvariate)
def vonmisesvariate_impl(mu, kappa):  # -> Callable[..., float | Any] | None:
    ...
@overload(np.random.vonmises)
def vonmisesvariate_impl(mu, kappa):  # -> Callable[..., float | Any] | None:
    ...
@overload(np.random.vonmises)
def vonmises_impl(mu, kappa, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
...
def binomial_impl(
    n, p, size
):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[signedinteger[_NBitIntP]]] | None:
    ...
@overload(np.random.chisquare)
def chisquare_impl(df):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.chisquare)
def chisquare_impl2(df, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
@overload(np.random.f)
def f_impl(dfnum, dfden):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.f)
def f_impl(dfnum, dfden, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
@overload(np.random.geometric)
def geometric_impl(p):  # -> Callable[..., int] | None:
    ...
@overload(np.random.geometric)
def geometric_impl(p, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[signedinteger[_64Bit]]] | None:
    ...
@overload(np.random.gumbel)
def gumbel_impl(loc, scale):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.gumbel)
def gumbel_impl3(loc, scale, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
@overload(np.random.hypergeometric)
def hypergeometric_impl(ngood, nbad, nsample):  # -> Callable[..., int] | None:
    ...
@overload(np.random.hypergeometric)
def hypergeometric_impl(
...
def laplace_impl2(loc, scale):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.laplace)
def laplace_impl3(loc, scale, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
...
def logistic_impl2(loc, scale):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.logistic)
def logistic_impl3(loc, scale, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
def logistic_impl(loc, scale): ...
@overload(np.random.logseries)
def logseries_impl(p):  # -> Callable[..., signedinteger[_64Bit] | Literal[1, 2] | None] | None:
    ...
@overload(np.random.logseries)
def logseries_impl(p, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[signedinteger[_64Bit]]] | None:
    ...
...
def poisson_impl0():  # -> Callable[[], int]:
    ...
@overload(np.random.poisson)
def poisson_impl1(lam):  # -> Callable[..., Callable[..., Any]] | None:
    ...
@overload(np.random.poisson)
def poisson_impl2(
    lam, size
...
def power_impl(a):  # -> Callable[..., float] | None:
    ...
@overload(np.random.power)
def power_impl(a, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
...
def rayleigh_impl1(scale):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.rayleigh)
def rayleigh_impl2(scale, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
@overload(np.random.standard_cauchy)
def cauchy_impl():  # -> Callable[[], float]:
    ...
@overload(np.random.standard_cauchy)
def standard_cauchy_impl(size):  # -> Callable[..., float] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
@overload(np.random.standard_t)
def standard_t_impl(df):  # -> Callable[..., float] | None:
    ...
@overload(np.random.standard_t)
def standard_t_impl2(df, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
@overload(np.random.wald)
def wald_impl(mean, scale):  # -> Callable[..., Any] | None:
    ...
@overload(np.random.wald)
def wald_impl2(mean, scale, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[float64]] | None:
    ...
@overload(np.random.zipf)
def zipf_impl(a):  # -> Callable[..., int | None] | None:
    ...
@overload(np.random.zipf)
def zipf_impl(a, size):  # -> Callable[..., Any] | Callable[..., NDArray[Any]] | Callable[..., _Array1D[signedinteger[_NBitIntP]]] | None:
    ...
...
def rand(*size):  # -> Callable[..., float] | Callable[..., NDArray[float64]]:
    ...
@overload(np.random.randn)
def randn(*size):  # -> Callable[..., float] | Callable[..., NDArray[float64]]:
    ...
@overload(np.random.choice)
def choice(a, size=..., replace=...):  # -> Callable[..., Any]:
    ...
@overload(np.random.multinomial)
def multinomial(n, pvals, size=...):  # -> Callable[..., _Array1D[signedinteger[_NBitIntP]]] | Callable[..., Any]:
    ...
@overload(np.random.dirichlet)
def dirichlet(alpha):  # -> Callable[..., _Array1D[float64]] | None:
    ...
@overload(np.random.dirichlet)
def dirichlet(alpha, size=...):  # -> Callable[..., _Array1D[float64]] | Callable[..., Any]:
    ...
@register_jitable
...
def noncentral_chisquare(df, nonc):  # -> Callable[..., float | Any] | None:
    ...
@overload(np.random.noncentral_chisquare)
def noncentral_chisquare(df, nonc, size=...):  # -> Callable[..., float | Any] | Callable[..., NDArray[Any]] | Callable[..., Any]:
    ...
@register_jitable
