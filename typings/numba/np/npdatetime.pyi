...
def reduce_datetime_for_unit(
    builder, dt_val, src_unit, dest_unit
):  # -> tuple[Any, Any] | tuple[Any, Literal['W']] | tuple[Any, Literal['D']]:
    ...
...
def ol_hash_npdatetime(x):  # -> Callable[..., signedinteger[_32Bit]] | Callable[..., signedinteger[_64Bit]]:
    ...
