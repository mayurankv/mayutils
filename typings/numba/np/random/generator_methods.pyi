...
def NumPyRandomGeneratorType_integers(
    inst, low, high, size=..., dtype=..., endpoint=...
):  # -> Callable[..., Any] | Callable[..., _Array1D[float64] | Any]:
    ...
...
def NumPyRandomGeneratorType_random(inst, size=..., dtype=...):  # -> Callable[..., Any | Signature] | Callable[..., Any]:
    ...
@overload_method(types.NumPyRandomGeneratorType, "standard_exponential")
def NumPyRandomGeneratorType_standard_exponential(
    inst, size=..., dtype=..., method=...
):  # -> Callable[..., Any | Signature] | Callable[..., Any]:
    ...
@overload_method(types.NumPyRandomGeneratorType, "standard_normal")
def NumPyRandomGeneratorType_standard_normal(inst, size=..., dtype=...):  # -> Callable[..., Any | Signature] | Callable[..., Any]:
    ...
@overload_method(types.NumPyRandomGeneratorType, "standard_gamma")
def NumPyRandomGeneratorType_standard_gamma(inst, shape, size=..., dtype=...):  # -> Callable[..., Any | Signature] | Callable[..., Any]:
    ...
...
def NumPyRandomGeneratorType_beta(inst, a, b, size=...):  # -> Callable[..., Any | float | None] | Callable[..., Any]:
    ...
...
def NumPyRandomGeneratorType_chisquare(inst, df, size=...):  # -> Callable[..., Any | float] | Callable[..., Any]:
    ...
...
def NumPyRandomGeneratorType_weibull(inst, a, size=...):  # -> Callable[..., float | Any] | Callable[..., Any]:
    ...
...
def NumPyRandomGeneratorType_geometric(inst, p, size=...):  # -> Callable[..., signedinteger[_64Bit]] | Callable[..., Any]:
    ...
@overload_method(types.NumPyRandomGeneratorType, "zipf")
def NumPyRandomGeneratorType_zipf(inst, a, size=...):  # -> Callable[..., int64] | Callable[..., Any]:
    ...
...
def NumPyRandomGeneratorType_poisson(inst, lam, size=...):  # -> Callable[..., int64] | Callable[..., Any]:
    ...
@overload_method(types.NumPyRandomGeneratorType, "negative_binomial")
def NumPyRandomGeneratorType_negative_binomial(inst, n, p, size=...):  # -> Callable[..., int64] | Callable[..., Any]:
    ...
@overload_method(types.NumPyRandomGeneratorType, "noncentral_chisquare")
def NumPyRandomGeneratorType_noncentral_chisquare(inst, df, nonc, size=...):  # -> Callable[..., float64] | Callable[..., Any]:
    ...
@overload_method(types.NumPyRandomGeneratorType, "noncentral_f")
def NumPyRandomGeneratorType_noncentral_f(inst, dfnum, dfden, nonc, size=...):  # -> Callable[..., float64] | Callable[..., Any]:
    ...
@overload_method(types.NumPyRandomGeneratorType, "logseries")
def NumPyRandomGeneratorType_logseries(inst, p, size=...):  # -> Callable[..., int64] | Callable[..., Any]:
    ...
@overload_method(types.NumPyRandomGeneratorType, "binomial")
def NumPyRandomGeneratorType_binomial(inst, n, p, size=...):  # -> Callable[..., int64] | Callable[..., Any]:
    ...
