...
def random_standard_exponential_inv(bitgen):  # -> Any:
    ...
@register_jitable
def random_standard_exponential_inv_f(bitgen):  # -> Any:
    ...
@register_jitable
...
def random_gamma_f(bitgen, shape, scale):  # -> Signature:
    ...
@register_jitable
def random_beta(bitgen, a, b):  # -> Any | float | None:
    ...
@register_jitable
def random_chisquare(bitgen, df):  # -> Any | float:
    ...
@register_jitable
def random_f(bitgen, dfnum, dfden): ...
@register_jitable
def random_standard_cauchy(bitgen):  # -> Any:
    ...
@register_jitable
...
def random_negative_binomial(bitgen, n, p):  # -> int | None:
    ...
@register_jitable
def random_noncentral_chisquare(bitgen, df, nonc):  # -> float | Any:
    ...
@register_jitable
