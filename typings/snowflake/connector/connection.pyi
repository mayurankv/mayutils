...
class SnowflakeConnection:
    ...
    def execute_string(self, sql_text: str, remove_comments: bool = ..., return_cursors: bool = ..., cursor_class: SnowflakeCursor = ..., **kwargs) -> Iterable[SnowflakeCursor]:
        ...
    
    def execute_stream(self, stream: StringIO, remove_comments: bool = ..., cursor_class: SnowflakeCursor = ..., **kwargs) -> Generator[SnowflakeCursor]:
        ...
    ...
    def cmd_query(self, sql: str, sequence_counter: int, request_id: uuid.UUID, binding_params: None | tuple | dict[str, dict[str, str]] = ..., binding_stage: str | None = ..., is_file_transfer: bool = ..., statement_params: dict[str, str] | None = ..., is_internal: bool = ..., describe_only: bool = ..., _no_results: bool = ..., _update_current_object: bool = ..., _no_retry: bool = ..., timeout: int | None = ..., dataframe_ast: str | None = ...) -> dict[str, Any]:
        ...
