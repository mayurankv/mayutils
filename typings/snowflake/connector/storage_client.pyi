...
class SnowflakeStorageClient(ABC):
    ...
    SLEEP_MAX = ...
    SLEEP_UNIT = ...
    def __init__(self, meta: SnowflakeFileMeta, stage_info: dict[str, Any], chunk_size: int, chunked_transfer: bool | None = ..., credentials: StorageCredential | None = ..., max_retry: int = ..., unsafe_file_write: bool = ...) -> None:
        ...
