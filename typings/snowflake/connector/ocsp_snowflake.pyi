...
class SnowflakeOCSP:
    ...
    def __init__(self, ocsp_response_cache_uri=..., use_ocsp_cache_server=..., use_post_method: bool = ..., use_fail_open: bool = ..., root_certs_dict_lock_timeout: int = ..., **kwargs) -> None:
        ...
    
    def validate_certfile(self, cert_filename, no_exception: bool = ...):
        ...
    
    def validate(self, hostname: str | None, connection: Connection, no_exception: bool = ...) -> list[tuple[Exception | None, Certificate, Certificate, CertId, str | bytes]] | None:
        ...
    ...
    def validate_by_direct_connection(self, issuer: Certificate, subject: Certificate, telemetry_data: OCSPTelemetryData, hostname: str = ..., do_retry: bool = ..., **kwargs: Any) -> tuple[Exception | None, Certificate, Certificate, CertId, bytes]:
        ...
