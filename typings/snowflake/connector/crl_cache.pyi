...
class CRLFileCache(CRLCache):
    def __init__(self, cache_dir: Path | None = ..., removal_delay: timedelta | None = ..., unsafe_skip_file_permissions_check: bool = ...) -> None:
        ...
...
class CRLCacheFactory:
    ...
    @classmethod
    def get_file_cache(cls, cache_dir: Path | None = ..., removal_delay: timedelta | None = ..., unsafe_skip_file_permissions_check: bool = ...) -> CRLFileCache:
        ...
