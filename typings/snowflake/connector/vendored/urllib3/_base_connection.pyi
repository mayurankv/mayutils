...
This type stub file was generated by pyright.
"""
_TYPE_BODY = bytes | typing.IO[typing.Any] | typing.Iterable[bytes] | str
...
if typing.TYPE_CHECKING:
    class BaseHTTPConnection(Protocol):
        ...
        def __init__(self, host: str, port: int | None = ..., *, timeout: _TYPE_TIMEOUT = ..., source_address: tuple[str, int] | None = ..., blocksize: int = ..., socket_options: _TYPE_SOCKET_OPTIONS | None = ..., proxy: Url | None = ..., proxy_config: ProxyConfig | None = ...) -> None:
            ...
