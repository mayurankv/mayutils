...
if HAS_NEVER_CHECK_COMMON_NAME and not _is_has_never_check_common_name_reliable(OPENSSL_VERSION, OPENSSL_VERSION_NUMBER, sys.implementation.name, sys.version_info, sys.pypy_version_info if sys.implementation.name == "pypy" else None):
    HAS_NEVER_CHECK_COMMON_NAME = ...
_TYPE_PEER_CERT_RET = _TYPE_PEER_CERT_RET_DICT | bytes | None
...
def create_urllib3_context(ssl_version: int | None = ..., cert_reqs: int | None = ..., options: int | None = ..., ciphers: str | None = ..., ssl_minimum_version: int | None = ..., ssl_maximum_version: int | None = ..., verify_flags: int | None = ...) -> ssl.SSLContext:
    ...
