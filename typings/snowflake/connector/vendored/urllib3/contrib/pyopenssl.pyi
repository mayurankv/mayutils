...
class PyOpenSSLContext:
    ...
    def wrap_socket(self, sock: socket_cls, server_side: bool = ..., do_handshake_on_connect: bool = ..., suppress_ragged_eofs: bool = ..., server_hostname: bytes | str | None = ...) -> WrappedSocket:
        ...
