...
class _RequestVerbsUsingSessionMixin(abc.ABC):
    ...
    def get(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | tuple[int, int] | None = ..., use_pooling: bool | None = ..., **kwargs):
        ...
    
    def options(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., **kwargs):
        ...
    
    def head(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., **kwargs):
        ...
    
    def post(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., data=..., json=..., **kwargs):
        ...
    
    def put(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., data=..., **kwargs):
        ...
    
    def patch(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., data=..., **kwargs):
        ...
    
    def delete(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., **kwargs):
        ...
...
class SessionManager(_RequestVerbsUsingSessionMixin, _HttpConfigDirectAccessMixin):
    ...
    def request(self, method: str, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., **kwargs: Any) -> Response:
        ...
...
def request(method: str, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., session_manager: SessionManager | None = ..., use_pooling: bool | None = ..., **kwargs: Any) -> Response:
    ...
