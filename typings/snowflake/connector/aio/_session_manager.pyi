...
from ..session_manager import BaseHttpConfig, SessionManager as SessionManagerSync, SessionPool as SessionPoolSync, _BaseConfigDirectAccessMixin
...
class _RequestVerbsUsingSessionMixin(abc.ABC):
    ...
    async def get(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | tuple[int, int] | None = ..., use_pooling: bool | None = ..., **kwargs) -> aiohttp.ClientResponse:
        ...
    
    async def options(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., **kwargs) -> aiohttp.ClientResponse:
        ...
    
    async def head(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., **kwargs) -> aiohttp.ClientResponse:
        ...
    
    async def post(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., data=..., json=..., **kwargs) -> aiohttp.ClientResponse:
        ...
    
    async def put(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., data=..., **kwargs) -> aiohttp.ClientResponse:
        ...
    
    async def patch(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., data=..., **kwargs) -> aiohttp.ClientResponse:
        ...
    
    async def delete(self, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., **kwargs) -> aiohttp.ClientResponse:
        ...
...
class SessionManager(_RequestVerbsUsingSessionMixin, SessionManagerSync, _AsyncHttpConfigDirectAccessMixin):
    ...
    async def request(self, method: str, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., use_pooling: bool | None = ..., **kwargs: Any) -> aiohttp.ClientResponse:
        ...
...
async def request(method: str, url: str, *, headers: Mapping[str, str] | None = ..., timeout: int | None = ..., session_manager: SessionManager | None = ..., use_pooling: bool | None = ..., **kwargs: Any) -> aiohttp.ClientResponse:
    ...
