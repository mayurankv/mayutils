...
class SnowflakeRestful(SnowflakeRestfulSync):
    ...
    async def request(self, url, body=..., method: str = ..., client: str = ..., timeout: int | None = ..., _no_results: bool = ..., _include_retry_params: bool = ..., _no_retry: bool = ...):
        ...
    ...
    async def fetch(self, method: str, full_url: str, headers: dict[str, Any], data: dict[str, Any] | None = ..., timeout: int | None = ..., **kwargs) -> dict[Any, Any]:
        ...
