...
class SnowflakeConnection(SnowflakeConnectionSync):
    ...
    async def execute_stream(self, stream: StringIO, remove_comments: bool = ..., cursor_class: type[SnowflakeCursor] = ..., **kwargs) -> AsyncIterator[SnowflakeCursor, None, None]:
        ...
    
    async def execute_string(self, sql_text: str, remove_comments: bool = ..., return_cursors: bool = ..., cursor_class: type[SnowflakeCursor] = ..., **kwargs) -> Iterable[SnowflakeCursor]:
        ...
