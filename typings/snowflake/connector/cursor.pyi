...
from typing import Any, IO, Literal, NamedTuple, NoReturn, Self, TYPE_CHECKING, TypeVar, overload
...
class ResultMetadataV2:
    def __init__(self, name: str, type_code: int, is_nullable: bool, display_size: int | None = ..., internal_size: int | None = ..., precision: int | None = ..., scale: int | None = ..., vector_dimension: int | None = ..., fields: list[ResultMetadataV2] | None = ...) -> None:
        ...
...
class SnowflakeCursorBase[FetchRow: tuple[Any, ...] | dict[str, Any]](abc.ABC):
    ...
    @overload
    def execute(self, command: str, params: Sequence[Any] | dict[Any, Any] | None = ..., _bind_stage: str | None = ..., timeout: int | None = ..., _exec_async: bool = ..., _no_retry: bool = ..., _do_reset: bool = ..., _put_callback: SnowflakeProgressPercentage = ..., _put_azure_callback: SnowflakeProgressPercentage = ..., _put_callback_output_stream: IO[str] = ..., _get_callback: SnowflakeProgressPercentage = ..., _get_azure_callback: SnowflakeProgressPercentage = ..., _get_callback_output_stream: IO[str] = ..., _show_progress_bar: bool = ..., _statement_params: dict[str, str] | None = ..., _is_internal: bool = ..., _describe_only: bool = ..., _no_results: Literal[False] = ..., _is_put_get: bool | None = ..., _raise_put_get_error: bool = ..., _force_put_overwrite: bool = ..., _skip_upload_on_content_match: bool = ..., file_stream: IO[bytes] | None = ..., num_statements: int | None = ..., _dataframe_ast: str | None = ...) -> Self | None:
        ...
    
    @overload
    def execute(self, command: str, params: Sequence[Any] | dict[Any, Any] | None = ..., _bind_stage: str | None = ..., timeout: int | None = ..., _exec_async: bool = ..., _no_retry: bool = ..., _do_reset: bool = ..., _put_callback: SnowflakeProgressPercentage = ..., _put_azure_callback: SnowflakeProgressPercentage = ..., _put_callback_output_stream: IO[str] = ..., _get_callback: SnowflakeProgressPercentage = ..., _get_azure_callback: SnowflakeProgressPercentage = ..., _get_callback_output_stream: IO[str] = ..., _show_progress_bar: bool = ..., _statement_params: dict[str, str] | None = ..., _is_internal: bool = ..., _describe_only: bool = ..., _no_results: Literal[True] = ..., _is_put_get: bool | None = ..., _raise_put_get_error: bool = ..., _force_put_overwrite: bool = ..., _skip_upload_on_content_match: bool = ..., file_stream: IO[bytes] | None = ..., num_statements: int | None = ..., _dataframe_ast: str | None = ...) -> dict[str, Any] | None:
        ...
    
    def execute(self, command: str, params: Sequence[Any] | dict[Any, Any] | None = ..., _bind_stage: str | None = ..., timeout: int | None = ..., _exec_async: bool = ..., _no_retry: bool = ..., _do_reset: bool = ..., _put_callback: SnowflakeProgressPercentage = ..., _put_azure_callback: SnowflakeProgressPercentage = ..., _put_callback_output_stream: IO[str] = ..., _get_callback: SnowflakeProgressPercentage = ..., _get_azure_callback: SnowflakeProgressPercentage = ..., _get_callback_output_stream: IO[str] = ..., _show_progress_bar: bool = ..., _statement_params: dict[str, str] | None = ..., _is_internal: bool = ..., _describe_only: bool = ..., _no_results: bool = ..., _is_put_get: bool | None = ..., _raise_put_get_error: bool = ..., _force_put_overwrite: bool = ..., _skip_upload_on_content_match: bool = ..., file_stream: IO[bytes] | None = ..., num_statements: int | None = ..., _force_qmark_paramstyle: bool = ..., _dataframe_ast: str | None = ...) -> Self | dict[str, Any] | None:
        ...
