...
from .description import CLIENT_NAME, CLIENT_VERSION, COMPILER, IMPLEMENTATION, OPERATING_SYSTEM, PLATFORM, PYTHON_VERSION, SNOWFLAKE_CONNECTOR_VERSION
...
class SnowflakeRestful:
    def __init__(self, host: str = ..., port: int = ..., protocol: str = ..., inject_client_pause: int = ..., connection: SnowflakeConnection | None = ..., session_manager: SessionManager | None = ...) -> None:
        ...
    ...
    def request(self, url, body=..., method: str = ..., client: str = ..., timeout: int | None = ..., _no_results: bool = ..., _include_retry_params: bool = ..., _no_retry: bool = ...):
        ...
    ...
    def fetch(self, method: str, full_url: str, headers: dict[str, Any], data: dict[str, Any] | None = ..., timeout: int | None = ..., **kwargs) -> dict[Any, Any]:
        ...
    ...
    def log_and_handle_http_error_with_cause(self, e: Exception, full_url: str, method: str, retry_timeout: int, retry_count: int, conn: SnowflakeConnection, timed_out: bool = ...) -> None:
        ...
