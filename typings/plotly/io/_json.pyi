...
_swap_json = ...
_swap_orjson = ...
def to_json_plotly(plotly_object, pretty=..., engine=...):
    """
...
def to_json(fig, validate=..., pretty=..., remove_uids=..., engine=...):
    """
...
def write_json(fig, file, validate=..., pretty=..., remove_uids=..., engine=...):
    """
...
def from_json_plotly(value, engine=...):
    """
...
def from_json(value, output_type=..., skip_invalid=..., engine=...):
    """
...
def read_json(file, output_type=..., skip_invalid=..., engine=...):
    """
