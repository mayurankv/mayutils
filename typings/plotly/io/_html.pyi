...
def write_html(fig, file, config=..., auto_play=..., include_plotlyjs=..., include_mathjax=..., post_script=..., full_html=..., animation_opts=..., validate=..., default_width=..., default_height=..., auto_open=..., div_id=...):
    """
