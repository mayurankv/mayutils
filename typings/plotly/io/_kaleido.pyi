...
def write_image(fig: Union[dict, plotly.graph_objects.Figure], file: Union[str, Path], format: Union[str, None] = ..., scale: Union[int, float, None] = ..., width: Union[int, None] = ..., height: Union[int, None] = ..., validate: bool = ..., engine: Union[str, None] = ...):
    """
