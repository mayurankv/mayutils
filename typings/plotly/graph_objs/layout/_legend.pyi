...
class Legend(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg=..., bgcolor=..., bordercolor=..., borderwidth=..., entrywidth=..., entrywidthmode=..., font=..., groupclick=..., grouptitlefont=..., indentation=..., itemclick=..., itemdoubleclick=..., itemsizing=..., itemwidth=..., maxheight=..., orientation=..., title=..., titleclick=..., titledoubleclick=..., tracegroupgap=..., traceorder=..., uirevision=..., valign=..., visible=..., x=..., xanchor=..., xref=..., y=..., yanchor=..., yref=..., **kwargs) -> None:
        """
