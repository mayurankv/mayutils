...
def gapminder(datetimes=..., centroids=..., year=..., pretty_names=..., return_type=...):
    """
...
def tips(pretty_names=..., return_type=...):
    """
...
def stocks(indexed=..., datetimes=..., return_type=...):
    """
...
def experiment(indexed=..., return_type=...):
    """
...
def medals_wide(indexed=..., return_type=...):
    """
...
def medals_long(indexed=..., return_type=...):
    """
    This dataset represents the medal table for Olympic Short Track Speed Skating for the
    top three nations as of 2020.
