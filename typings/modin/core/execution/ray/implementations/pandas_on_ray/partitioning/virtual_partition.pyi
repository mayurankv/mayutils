...
class PandasOnRayDataframeVirtualPartition(PandasDataframeAxisPartition):
    ...
    def deploy_splitting_func(cls, axis, func, f_args, f_kwargs, num_splits, *partitions, extract_metadata=...): # -> Any:
        ...
    
    @classmethod
    def deploy_axis_func(cls, axis, func, f_args, f_kwargs, num_splits, maintain_partitioning, *partitions, min_block_size, lengths=..., manual_partition=..., max_retries=...): # -> Any:
        """
    ...
    @classmethod
    def deploy_func_between_two_axis_partitions(cls, axis, func, f_args, f_kwargs, num_splits, len_of_left, other_shape, *partitions, min_block_size): # -> Any:
        """
