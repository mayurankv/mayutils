...
class ModinDataframe(ABC):
    ...
    """
    @abstractmethod
    def take_2d_labels_or_positional(self, row_labels: Optional[List[Hashable]] = ..., row_positions: Optional[List[int]] = ..., col_labels: Optional[List[Hashable]] = ..., col_positions: Optional[List[int]] = ...) -> ModinDataframe:
        """
    ...
    @abstractmethod
    def map(self, function: Callable, axis: Optional[Union[int, Axis]] = ..., dtypes: Optional[str] = ..., new_columns: Optional[List[Hashable]] = ...) -> ModinDataframe:
        """
    ...
    @abstractmethod
    def explode(self, axis: Union[int, Axis], function: Callable, result_schema: Optional[Dict[Hashable, type]] = ...) -> ModinDataframe:
        """
    ...
    @abstractmethod
    def window(self, axis: Union[int, Axis], reduce_fn: Callable, window_size: int, result_schema: Optional[Dict[Hashable, type]] = ...) -> ModinDataframe:
        """
    ...
    @abstractmethod
    def groupby(self, axis: Union[int, Axis], by: Union[str, List[str]], operator: Callable, result_schema: Optional[Dict[Hashable, type]] = ...) -> ModinDataframe:
        """
    ...
    @abstractmethod
    def reduce(self, axis: Union[int, Axis], function: Callable, dtypes: Optional[str] = ...) -> ModinDataframe:
        """
    ...
    @abstractmethod
    def tree_reduce(self, axis: Union[int, Axis], map_func: Callable, reduce_func: Optional[Callable] = ..., dtypes: Optional[str] = ...) -> ModinDataframe:
        """
    ...
    @abstractmethod
    def rename(self, new_row_labels: Optional[Union[Dict[Hashable, Hashable], Callable]] = ..., new_col_labels: Optional[Union[Dict[Hashable, Hashable], Callable]] = ...) -> ModinDataframe:
        """
    ...
    @abstractmethod
    def sort_by(self, axis: Union[int, Axis], labels: Union[str, List[str]], ascending: bool = ...) -> ModinDataframe:
        """
