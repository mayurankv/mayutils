...
from .utils import ColumnNullType, DTypeKind, DlpackDeviceType
...
class ProtocolColumn(ABC):
    ...
    @abstractmethod
    def get_chunks(self, n_chunks: Optional[int] = ...) -> Iterable[ProtocolColumn]:
        """
...
class ProtocolDataframe(ABC):
    ...
    version = ...
    @abstractmethod
    def __dataframe__(self, nan_as_null: bool = ..., allow_copy: bool = ...) -> ProtocolDataframe:
        """
    ...
    @abstractmethod
    def get_chunks(self, n_chunks: Optional[int] = ...) -> Iterable[ProtocolDataframe]:
        """
        Return an iterator yielding the chunks.
