...
- **plot.py**: Improve shift_title

### Fix

- **strings.py**: Fix type hint for String.join

## v3.9.0 (2026-07-15)

### Feat

- **strings.py**: Add string joining method and add plotly automargin to title

## v3.8.1 (2026-07-14)

### Fix

- **subplot.py**: Fix axisconfig popping details incorrectly
