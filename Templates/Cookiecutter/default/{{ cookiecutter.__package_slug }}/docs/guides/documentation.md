...
Use the [numpy](https://numpydoc.readthedocs.io/en/latest/format.html) docstring style. The mkdocstrings config in `mkdocs.yml` expects it, and the `numpydoc-validation` prek hook enforces it.
